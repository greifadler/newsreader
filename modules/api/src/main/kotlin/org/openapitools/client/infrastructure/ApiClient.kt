...
open class ApiClient(val baseUrl: String) {
    ...
    protected fun <T> updateAuthParams(requestConfig: RequestConfig<T>) {
        if (requestConfig.headers["x-authtoken"].isNullOrEmpty()) {
            if (apiKey["x-authtoken"] != null) {
                if (apiKeyPrefix["x-authtoken"] != null) {
                    requestConfig.headers["x-authtoken"] = apiKeyPrefix["x-authtoken"]!! + " " + apiKey["x-authtoken"]!!
                } else {
                    requestConfig.headers["x-authtoken"] = apiKey["x-authtoken"]!!
                }
            }
        }
    }
